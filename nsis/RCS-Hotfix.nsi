...
;General
  ...
  !define PACKAGE_NAME "RCS-Hotfix"
  !Define /file PACKAGE_VERSION "..\config\VERSION_BUILD"
  !Define /file PACKAGE_HF "..\config\VERSION"

  ;Name and file
  Name "RCS-Hotfix"
  OutFile "rcs-hotfix-${PACKAGE_HF}.exe"
...
Section "Install Section" SecInstall
  ...
  DetailPrint "Stopping RCS..."
  SimpleSC::StopService "RCSDB" 1

  ; ===============================
  ; Hotfix FILES
  ; ===============================
  DetailPrint "Extracting Hotfix files..."
...
Function .onInit
  ...
  IntCmp $R0 1 +3 0 0
    MessageBox MB_OK "RCS Hotfix can be installed only if RCS is already installed"
    Quit

  ; Only master node
  ReadRegDWORD $R0 HKLM "Software\HT\RCS" "master"
  IntCmp $R0 1 +3 0 0
    MessageBox MB_OK "RCS Hotfix can be installed only on the RCS Master Node"
    Quit
