...
if File.directory?(Dir.pwd + '/lib/rcs-intelligence-release')
  require_relative 'rcs-intelligence-release/intelligence'
# otherwise we are using development code
elsif File.directory?(Dir.pwd + '/lib/rcs-intelligence')
  puts "WARNING: Executing clear text code... (debug only)"
  require_relative 'rcs-intelligence/intelligence.rb'
else
  puts "FATAL: cannot find any rcs-intelligence code!"
end
